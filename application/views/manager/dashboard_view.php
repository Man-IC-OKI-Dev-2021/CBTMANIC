...
<section class="content">
    <div class="box box-default collapsed-box">
        ...
        <div class="box-body">
            Teruntuk Putra kami tercinta. M. Azzam Pradito dan M. Azka Alfatih
        </div><!-- /.box-body -->
    </div><!-- /.box -->
        ...
        <div class="box-body">
            <dl>
                <dd>
					...
					CBT, maka anda setuju untuk :
                    <ol>
                        <li>Tidak mengubah Nama Aplikasi Ujian Online <b>Tito' CBT</b> menjadi nama aplikasi lain</li>
                        <li>Tidak mengubah footer yang menunjukkan alamat website Aplikasi Ujian Online Tito' CBT</li>
                        <li>Tidak menjual Aplikasi Ujian Online Tito' CBT. Tetapi anda diperbolehkan untuk mengambil keuntungan dari jasa proses instalasi, konsultasi dan lain sebagainya yang berkaitan dengan Aplikasi Ujian Online Tito CBT</li>
                        <li>Tidak menhapus tribute dan Perjanjian Penggunaan</li>
                    </ol>
                    Semoga Aplikasi Ujian Online Tito' CBT dapat bermanfaat untuk kita semua.
                </dd>
            </dl>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif TitO CBT, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online. CP : 0821 7559 1700</p>
    </div>
    <div class="box">
        <div class="box-header with-border">
